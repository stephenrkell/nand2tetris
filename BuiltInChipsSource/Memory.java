...
public class Memory extends BuiltInGate {

    public Memory() {
    }

    public short getValueAt(int index) throws GateException {
        throw new GateException("Memory cannot be used as a variable");
    }

    public void setValueAt(int index, short value) throws GateException {
        throw new GateException("Memry cannot be used as a variable");
    }
}
